function Footer() {
    ...
    <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <div>
            <h3 className="text-xl font-bold text-gray-400">MatchPoint </h3>
            <p className="mt-4 text-sm text-gray-400">Transforming careers, one resume at a time.</p>
        </div>
        <br />
        ...
        <div className="mt-8 text-center text-gray-400 text-sm">
                ...
                <p>MatchPoint™ is a trademark of MatchPoint Inc.</p>
            </div>
